...
public class Method extends Driver {
					...
					switch (i) {
						case 0 :
							if (identify[0] != "") {
								...
								cDriver.get().findElement(By.xpath(identify[0])).sendKeys(
										String.valueOf(val.charAt(0)));
								String brfound = "no";
								while (brfound != "yes") {
									String brcode = cDriver.get().findElement(
											By.xpath(identify[0]))
											.getAttribute("value");
									if (brcode.contains(val)) {
										cDriver.get().findElement(By.xpath(identify[0]))
												.click();
										brfound = "yes";
										break;
									} else {
						...
						case 1 :
							if (identify[1] != "") {
								...
								cDriver.get().findElement(By.name(identify[1])).sendKeys(
										String.valueOf(val.charAt(0)));
								String brfound = "no";
								while (brfound != "yes") {
									String brcode = cDriver.get().findElement(
											By.name(identify[1])).getAttribute("value");
									if (brcode.contains(val)) {
										cDriver.get().findElement(By.name(identify[1]))
												.click();
										brfound = "yes";
										break;
									} else {
						...
						case 2 :
							if (identify[2] != "") {
								...
								cDriver.get().findElement(By.id(identify[2])).sendKeys(
										String.valueOf(val.charAt(0)));
								String brfound = "no";
								while (brfound != "yes") {
									String brcode = cDriver.get().findElement(
											By.id(identify[2])).getAttribute("value");
									if (brcode.contains(val)) {
										cDriver.get().findElement(By.id(identify[2])).click();
										brfound = "yes";
										break;
									} else {
										cDriver.get().findElement(By.id(identify[2]))
												.sendKeys(Keys.ARROW_DOWN);
									}
								}
								break;
						...
						case 3 :
							if (identify[3] != "") {
								...
								cDriver.get().findElement(By.className(identify[3])).sendKeys(
										String.valueOf(val.charAt(0)));
								String brfound = "no";
								while (brfound != "yes") {
									String brcode = cDriver.get().findElement(
											By.className(identify[3])).getAttribute(
											"value");
									if (brcode.contains(val)) {
						...
						case 4 :
							if (identify[4] != "") {
								...
								cDriver.get().findElement(By.linkText(identify[4])).sendKeys(
										String.valueOf(val.charAt(0)));
								String brfound = "no";
								while (brfound != "yes") {
									String brcode = cDriver.get().findElement(
											By.linkText(identify[4])).getAttribute(
											"value");
									if (brcode.contains(val)) {
										cDriver.get().findElement(By.linkText(identify[4]))
												.click();
										brfound = "yes";
										break;
									} else {
			...
			try {
				if (Driver.Continue.get() == true) {
					switch (i) {
						case 0 :
							if (identify[0] != "") {
								TxtVal = cDriver.get().findElement(
										By.xpath(identify[0])).getAttribute(
										"value");
								break;
							} else {
								throw new Exception(Error);
						...
						case 1 :
							if (identify[1] != "") {
								TxtVal = cDriver.get().findElement(
										By.name(identify[1])).getAttribute(
										"value");
								break;
							} else {
								throw new Exception(Error);
						...
						case 2 :
							if (identify[2] != "") {
								TxtVal = cDriver.get().findElement(By.id(identify[2]))
										.getAttribute("value");
								break;
							} else {
								throw new Exception(Error);
	 ...
	 * Last Modified Date 	: 25-Apr-2016
	--------------------------------------------------------------------------------------------------------*/
	public static void Methodwaittillenabled(String[] identify)
